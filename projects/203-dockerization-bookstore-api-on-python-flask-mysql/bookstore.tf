...
resource "aws_instance" "tf-docker-ec2" {
    ...
    user_data = <<-EOF
               ...
               TOKEN="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"
               FOLDER="https://$TOKEN@raw.githubusercontent.com/benjamingoldenage/bookstoreapi-project-new/main/"
               ...
               docker build -t 42542817/bookstoreapi:latest .
               docker-compose up -d
               EOF
}
